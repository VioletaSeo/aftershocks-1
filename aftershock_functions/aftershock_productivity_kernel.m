...
[MSt,MSlat,MSlon,MSdepth,MSmag,MSfms,MSprod,FSprod] = goodind(I,MSt,MSlat,MSlon,MSdepth,MSmag,MSfms, numberOfAftershocks',numberOfForeshocks'); %#ok<ASGLU>
...
for mm=maxmag:-0.1:minmag
    ...
    Dt          = 60; %dt9*10^(mm-9);
    DtFS        = 1;  %foreshockTimeWin*10^(mm-9);
    Dtbig       = 100; %dt9max*10^(mm-9); % scaled time window
